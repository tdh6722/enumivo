...
````bash
cleos set contract enumivo build/contracts/enumivo.bios -p enumivo
````

##### Ceate enumivo.coin account
````bash
cleos create account enumivo enumivo.coin EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4 EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4
````
...
##### Create dice account
````bash
cleos create account enumivo dice EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4 EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4
````
...
````bash
cleos push action enumivo.coin create '[ "enumivo", "1000000000.0000 EOS", 0, 0, 0]' -p enumivo.coin
````

##### Create alice account
````bash
cleos create account enumivo alice EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4 EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4
````

##### Create bob account
````bash
cleos create account enumivo bob EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4 EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4
````

##### Issue 1000 EOS to alice
````bash
cleos push action enumivo.coin issue '[ "alice", "1000.0000 EOS", "" ]' -p enumivo
````

##### Issue 1000 EOS to bob
````bash
cleos push action enumivo.coin issue '[ "bob", "1000.0000 EOS", "" ]' -p enumivo
````
