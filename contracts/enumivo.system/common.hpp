...
namespace enumivosystem {
   ...
   class common {
      public:
         ...
         struct enumivo_parameters : eosio::blockchain_parameters {
            ...
            EOSLIB_SERIALIZE_DERIVED( enumivo_parameters, eosio::blockchain_parameters, (percent_of_max_inflation_rate)(storage_reserve_ratio) )
         };
         ...
         struct enumivo_global_state : enumivo_parameters {
            ...
            EOSLIB_SERIALIZE_DERIVED( enumivo_global_state, enumivo_parameters, (total_storage_bytes_reserved)(total_storage_stake)
                                      (payment_per_block)(payment_to_eos_bucket)(first_block_time_in_cycle)(blocks_per_cycle)
                                      (last_bucket_fill_time)(eos_bucket) )
         };

         typedef eosio::singleton<SystemAccount, N(inflation), SystemAccount, enumivo_global_state> global_state_singleton;
