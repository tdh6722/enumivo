...
{
    {
       ...
       enu_assert(b == a, "fixed_point128 instances comparison with same number of decimals");
       enu_assert(c == a, "fixed_point128 instances with different number of decimals");
    }

    {
       ...
       enu_assert(b == a, "fixed_point64 instances comparison with same number of decimals");
       enu_assert(c == a, "fixed_point64 instances with different number of decimals");
    }

    {
       ...
       enu_assert(b == a, "fixed_point32 instances comparison with same number of decimals");
       enu_assert(c == a, "fixed_point32 instances with different number of decimals");
    }
}
...
{
    {
       ...
       enu_assert(c == d, "fixed_point32 instances addition with zero decmimals");
    }
    {
       // Various ways to create fixed_point64
       ...
       enu_assert(c == d, "fixed_point64 instances addition with zero decmimals");
    }
};
...
{
    {
       ...
       enu_assert(c == d, "fixed_point64 instances subtraction with zero decmimals");

       enumivo::fixed_point64<0> a1(0);
       enumivo::fixed_point64<0> c1 = a1 - b;
       enumivo::fixed_point64<0> d1 = -100;
       enu_assert(c1 == d1, "fixed_point64 instances subtraction with zero decmimals");
    }
    {
       // Various ways to create fixed_point32
       enumivo::fixed_point32<0> a(100);
       ...
       enu_assert(c == d, "fixed_point32 instances subtraction with zero decmimals");

       // Various ways to create fixed_point32
       enumivo::fixed_point32<0> a1(0);
       enumivo::fixed_point32<0> c1 = a1 - b;
       enumivo::fixed_point32<0> d1 = -100;
       enu_assert(c1 == d1, "fixed_point32 instances subtraction with zero decmimals");
...
{
    {
       ...
       enu_assert(c == d, "fixed_point64 instances multiplication result in fixed_point128");
    }

    {
       ...
       enu_assert(c == d, "fixed_point32 instances multiplication result in fixed_point64");
    }
}
...
{
    {
        ...
        print(e);
        enu_assert(c == e, "fixed_point64 instances division result from operator and function and compare in fixed_point128");
