...
namespace enumivo {
   ...
   class optional {
      public:
         ...
         T&       operator*()      { enu_assert(_valid, "dereference of empty optional"); return ref(); }
         const T& operator*()const { enu_assert(_valid, "dereference of empty optional"); return ref(); }

         T*       operator->()
         {
            enu_assert(_valid, "dereference of empty optional");
            return ptr();
         }
