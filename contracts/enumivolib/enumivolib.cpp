...
namespace enumivo {
   ...
   void get_blockchain_parameters(enumivo::blockchain_parameters& params) {
      ...
      enu_assert( size <= sizeof(buf), "buffer is too small" );
   ...
   */
   ...
   private:
      ...
      public:
         ...
         {
            enu_assert(_offset == _heap_size, "malloc_from_freed was designed to only be called after _heap was completely allocated");
