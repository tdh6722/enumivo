#!/bin/bash
#
# enumivo-tn_bounce is used to restart a node that is acting badly or is down.
# usage: enumivo-tn_bounce.sh [arglist]
...
# the command line.
#
# in most cases, simply running ./enumivo-tn_bounce.sh is sufficient.
#
...
bash $EOSIO_HOME/scripts/enumivo-tn_down.sh
bash $EOSIO_HOME/scripts/enumivo-tn_up.sh $*
