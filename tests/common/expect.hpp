...
namespace enumivo { namespace test {
...
#define EXPECT_3(P, E, T) enumivo::test::expect<P>(E,T,"EXPECT<" #P ">(" #E "," #T ")")
#define EXPECT_2(E, T) enumivo::test::expect(E,T,"EXPECT(" #E "," #T ")")
#define EXPECT_1(E) enumivo::test::expect(E,"EXPECT(" #E ")")
