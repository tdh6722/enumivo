...
(module
 ...
 (func $apply (param $0 i64) (param $1 i64)
    (call $enu_assert (i32.eq (i32.trunc_u/f32 (f32.const 0x3f800000)) (i32.const 0x0)) (i32.const 0))
  )
 )
)=====";
*/
...
(module
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (if (i64.eq (get_local $2) (i64.const 1)) (then
    (call $enu_assert (i64.eq (get_global $g0) (i64.const 2)) (i32.const 0))
    (return)
  ))
  (call $enu_assert (i32.const 0) (i32.const 0))
 )
...
(module
 (import "env" "require_auth" (func $require_auth (param i64)))
 (import "env" "enu_assert" (func $assert (param i32 i32)))
