...
namespace enumivo { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( block_concurrency_exception,       enumivo::chain::block_validate_exception, 3020002, "block does not guarantee concurrent exection without conflicts" )
