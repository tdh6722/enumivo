...
FC_REFLECT( enumivo::chain_apis::read_only::get_currency_stats_result, (supply));

FC_REFLECT( enumivo::chain_apis::read_only::get_account_results, (account_name)(permissions) )
...
FC_REFLECT( enumivo::chain_apis::read_only::abi_json_to_bin_result, (binargs)(required_scope)(required_auth) )
